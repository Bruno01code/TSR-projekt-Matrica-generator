...
function findWasmBinary() {
  return locateFile('matrice.wasm');
}
...
var _DohvatiElement = Module['_DohvatiElement'] = makeInvalidEarlyAccess('_DohvatiElement');
var _GenerirajMatricu = Module['_GenerirajMatricu'] = makeInvalidEarlyAccess('_GenerirajMatricu');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['DohvatiElement'] != 'undefined', 'missing Wasm export: DohvatiElement');
  assert(typeof wasmExports['GenerirajMatricu'] != 'undefined', 'missing Wasm export: GenerirajMatricu');
  ...
  _DohvatiElement = Module['_DohvatiElement'] = createExportWrapper('DohvatiElement', wasmExports['DohvatiElement'], 2);
  _GenerirajMatricu = Module['_GenerirajMatricu'] = createExportWrapper('GenerirajMatricu', wasmExports['GenerirajMatricu'], 2);
